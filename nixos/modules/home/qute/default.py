...
c.colors.tabs.even.fg = light5
c.colors.tabs.odd.bg = dark4
c.colors.tabs.odd.fg = light5
...
c.colors.tabs.selected.even.fg = dark5
c.colors.tabs.selected.odd.bg = light1
c.colors.tabs.selected.odd.fg = dark5
