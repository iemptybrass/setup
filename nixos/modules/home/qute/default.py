...
c.colors.tabs.bar.bg = dark4
c.colors.tabs.even.bg = dark7
c.colors.tabs.even.fg = light4
c.colors.tabs.indicator.error = dark4
c.colors.tabs.indicator.start = dark4
c.colors.tabs.indicator.stop = dark4
c.colors.tabs.indicator.system = 'none'
c.colors.tabs.odd.bg = dark7
c.colors.tabs.odd.fg = light4
...
c.colors.tabs.selected.even.fg = dark3
c.colors.tabs.selected.odd.bg = light1
c.colors.tabs.selected.odd.fg = dark3
